...
msgStart="啟動 (撿貨模式 2): 一次多品項。";
msgConfirmFinished='Finished this wave？';
msgStart="Start picking mode 2";
document.title = 'NextCS PUT TO WALL (Mode 2)';
...
//txtShortQty="要將撿貨數量改成"+ sNbr +" ？";
//txtShortQty="shortage？\n Pick Quantity will modify = "+ sNbr +" ？";
...
var aryLites=[  "lite_A1" ,	"lite_A2" ,	"lite_A3" ,	"lite_A4" ,
				...
				"lite_D1" ,	"lite_D2" ,	"lite_D3" ,	"lite_D4" ,
			 ];
